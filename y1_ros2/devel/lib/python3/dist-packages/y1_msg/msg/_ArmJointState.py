...
"""autogenerated by genpy from y1_msg/ArmJointState.msg. Do not edit."""
import codecs
import sys
...
class ArmJointState(genpy.Message):
  _md5sum = "303651795b96b734ba0e948b824c3d6f"
  _type = "y1_msg/ArmJointState"
...
string frame_id
"""
  __slots__ = ['header','end_pose','joint_position','joint_velocity','joint_effort']
  _slot_types = ['std_msgs/Header','float64[6]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,end_pose,joint_position,joint_velocity,joint_effort
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.joint_effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joint_effort))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joint_effort = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joint_effort.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joint_effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
