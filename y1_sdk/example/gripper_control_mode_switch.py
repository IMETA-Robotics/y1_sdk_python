...
if __name__ == "__main__":
    ...
    # SetGripperMode(False) 将夹爪切换为位置控制模式
    master_arm.SetGripperMode(False)
    master_arm.SetGripperStroke(0)
    time.sleep(10)

    print("gripper torque compensation")
    # SetGripperMode(True) 再将夹爪重新切换为重力补偿模式
    master_arm.SetGripperMode(True)
    time.sleep(10)
