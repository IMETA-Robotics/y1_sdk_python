...
PYBIND11_MODULE(y1_sdk, m) {
  ...
  py::enum_<imeta::y1_controller::Y1SDKInterface::ControlMode>(m, "ControlMode")
      ...
      .value("MIT_CONTROL",
             imeta::y1_controller::Y1SDKInterface::MIT_CONTROL)
      .export_values();
  ...
  py::class_<imeta::y1_controller::MitControlCommand>(m, "MitControlCommand")
      ...
      .def_readwrite("joint_position", &imeta::y1_controller::MitControlCommand::joint_position)
      .def_readwrite("kd", &imeta::y1_controller::MitControlCommand::kd)
      .def_readwrite("joint_velocity", &imeta::y1_controller::MitControlCommand::joint_velocity)
      .def_readwrite("torque", &imeta::y1_controller::MitControlCommand::torque);
  ...
  py::class_<imeta::y1_controller::Y1SDKInterface>(m, "Y1SDKInterface")
      ...
      // 新增的 MIT 控制方法
      .def("MitControlArm", &imeta::y1_controller::Y1SDKInterface::MitControlArm,
           "MIT control mode for arm motors J1-J6", py::arg("arm_control_command"))

      .def("MitControlGripper", &imeta::y1_controller::Y1SDKInterface::MitControlGripper,
